    ...
    : nh_(nh_private), it_(nh)
{
    ...
    imagePublisher_  = it_.advertise("/camera/image_raw", 1);
    imageSubscriber_ = it_.subscribe("/video/image_raw" , 1, &DefisheyeNode::imageCallback, this);
    ...
    nh_.param<std::string>("vertex_shader"  , vertexShader  , "/home/alpha/catkin_ws/src/opengl_ros/opengl_ros/shader/defisheye_vert.glsl");
    nh_.param<std::string>("fragment_shader", fragmentShader, "/home/alpha/catkin_ws/src/opengl_ros/opengl_ros/shader/defisheye_frag.glsl");
